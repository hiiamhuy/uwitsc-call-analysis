...
- **`OLLAMA_MODEL`**: Name of the preloaded Ollama model (default: `deepseek-r1:70b`)
...
- **GPU Partition**: `gpu-rtx6k` (default) - Your allocation: 10 CPUs, 81GB RAM, 2 GPUs (48GB VRAM each)
- **Job Resources**: 1 GPU, 81GB RAM, 4 CPUs per job (default, configurable)
- **Model**: WhisperX "large-v2" for transcription, Ollama "deepseek-r1:70b" for analysis
### Container Images
...
**Agent Keywords:**
- `AGENT_KEYWORDS` list - Main agent identification keywords

**User Keywords:**
- `user_phrases` list - Specific user phrases
- `short_responses` list - Common user responses like "yes", "no", "ok"
- `question_indicators` list - Agent questions that typically get user responses
- `repeat_patterns` list - User repeating agent information (Zoom IDs, names, etc.)
